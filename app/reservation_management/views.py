...
from app.reservation_management.decorators import lesson_owner_only
from app.reservation_management.forms import LessonForm
from app.reservation_management.models import Lesson, Reservation, Log, Feedback
...
class LessonAddView(LoginRequiredMixin, CreateView):
    ...
    template_name = "reservation_management/templates/reservation_management/lesson_add.html"
...
class LessonListView(LoginRequiredMixin, ListView):
    ...
    """
    model = Lesson
    template_name = "reservation_management/templates/reservation_management/lesson_list.html"
...
class LessonDetailView(DetailView):
    ...
    """
    model = Lesson
    template_name = "reservation_management/templates/reservation_management/lesson_detail.html"
...
class LessonUpdateView(UpdateView):
    ...
    model = Lesson
    form_class = LessonForm
    template_name = "reservation_management/templates/reservation_management/lesson_update.html"
...
class LessonDeleteView(DeleteView):
    ...
    """
    model = Lesson
    template_name = 'reservation_management/templates/reservation_management/lesson_delete.html'
    success_url = reverse_lazy('reservation_management:lesson-list')


class ReservationListView(LoginRequiredMixin, ListView):
    model = Reservation
    template_name = "reservation_management/templates/reservation_management/reservation_list.html"
...
class LogListView(ListView):
    model = Log
    template_name = "reservation_management/templates/reservation_management/log_list.html"
...
class FeedbackListView(ListView):
    model = Feedback
    template_name = "reservation_management/templates/reservation_management/feedback_list.html"
