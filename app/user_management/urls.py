...
from app.user_management import views
...
urlpatterns = [
    ...
    path('ajax-check-unimore-credentials', views.ajax_check_unimore_credentials, name='ajax-check-unimore-credentials'),
    ...
    path('greenpass-delete', views.UserGreenPassDeleteView.as_view(), name='green-pass-delete'),
