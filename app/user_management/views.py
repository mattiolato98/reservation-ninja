...
from app.user_management.check_unimore_credentials import check_unimore_credentials
from app.user_management.decorators import manager_required
from app.user_management.forms import LoginForm, PlatformUserCreationForm, UserUpdateUnimoreCredentialsForm, \
    UserAddGreenPass, UserGeneralSettings, UserDeleteGreenPass
from app.user_management.models import PlatformUser
...
class LoginUserView(LoginView):
    ...
    template_name = 'registration/templates/registration/login.html'


@method_decorator(not_authenticated_only, name='dispatch')
class RegistrationView(CreateView):
    form_class = PlatformUserCreationForm
    template_name = 'registration/templates/registration/registration.html'
...
class UserGeneralSettingsView(LoginRequiredMixin, UpdateView):
    ...
    template_name = 'user_management/templates/user_management/user_general_settings.html'
...
class UserUpdateUnimoreCredentialsView(LoginRequiredMixin, FormView):
    ...
    template_name = "user_management/templates/user_management/user_update_unimore_credentials.html"
    success_url = reverse_lazy('user_management:settings')
...
class UserDeleteView(LoginRequiredMixin, DeleteView):
    template_name = "user_management/templates/user_management/user_delete.html"
...
class UserListView(ListView):
    model = get_user_model()
    template_name = "user_management/templates/user_management/user_list.html"
...
class UserGreenPassAddView(LoginRequiredMixin, FormView):
    ...
    template_name = "user_management/templates/user_management/greenpass_add.html"
...
class UserGreenPassDeleteView(LoginRequiredMixin, FormView):
    ...
    template_name = "user_management/templates/user_management/greenpass_delete.html"
    success_url = reverse_lazy("user_management:settings")
...
class PrivacyPolicyView(TemplateView):
    template_name = "user_management/templates/user_management/privacy_policy.html"


class CookiePolicyView(TemplateView):
    template_name = "user_management/templates/user_management/cookie-policy.html"


class EmailVerificationNeededView(TemplateView):
    template_name = 'user_management/templates/user_management/email_verification_needed.html'


class EmailVerifiedView(TemplateView):
    template_name = 'user_management/templates/user_management/email_verified.html'


class SettingsView(LoginRequiredMixin, TemplateView):
    template_name = "user_management/templates/user_management/settings.html"
